...
export const products: Product[] = [
	{
		...
		shortDescription: "Готовая шпатлевка DANOGIPS SuperFinish 28 кг для финишной отделки стен и потолков. Идеально гладкая поверхность, удобна в нанесении. Цена 650 ₽. ДомСтрой.",
		price: "650",
		images: [
